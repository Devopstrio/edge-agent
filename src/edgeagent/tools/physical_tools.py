...
class ShutdownMachineTool(BaseTool): # type: ignore[override, misc]
    ...
    description: str = "Use this tool to issue an emergency shutdown command to a physical machine when dangerous anomalies are detected."
...
class TriggerAlarmTool(BaseTool): # type: ignore[override, misc]
    ...
    description: str = "Use this tool to sound physical sirens and flashing lights in a specific factory zone to alert human operators."
